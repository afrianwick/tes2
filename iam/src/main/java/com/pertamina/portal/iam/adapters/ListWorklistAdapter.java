 ...
 */
public class ListWorklistAdapter extends RecyclerView.Adapter<ListWorklistAdapter.ViewHolder> {

    private final List<Task> mValues;
    private final OnListFragmentInteractionListener mListener;
    private final Activity mActivity;

    public ListWorklistAdapter(Activity activity, List<Task> items, OnListFragmentInteractionListener listener) {
        mActivity = activity;
        mValues = items;
        mListener = listener;
    }
