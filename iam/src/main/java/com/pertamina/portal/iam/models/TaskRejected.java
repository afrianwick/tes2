...
public class TaskRejected extends RealmObject {
    public String id;
    ...
    public TaskRejected(String id, boolean statusNotif, String folioNumber, String processName, String lastActivity) {
        this.id = id;
