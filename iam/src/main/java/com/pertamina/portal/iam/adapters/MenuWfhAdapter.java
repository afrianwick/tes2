...
import com.pertamina.portal.iam.models.WfhMenu;

import java.util.List;

public class MenuWfhAdapter extends BaseAdapter {

    private final Context mContext;
    private final List<WfhMenu> menus;

    public MenuWfhAdapter(Context context, List<WfhMenu> menus) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final WfhMenu menu = menus.get(position);
