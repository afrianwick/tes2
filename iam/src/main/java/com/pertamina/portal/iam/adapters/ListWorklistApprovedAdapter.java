...
/**
 * {@link RecyclerView.Adapter} that can display a {@link TaskApproval} and makes a call to the
 * specified {@link OnListFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class ListWorklistApprovedAdapter extends RecyclerView.Adapter<ListWorklistApprovedAdapter.ViewHolder> {

    private final List<TaskApproval> mValues;
    private final OnListFragmentInteractionListener mListener;
    private final Activity mActivity;

    public ListWorklistApprovedAdapter(Activity activity, List<TaskApproval> items, OnListFragmentInteractionListener listener) {
        mActivity = activity;
        mValues = items;
        mListener = listener;
    }
