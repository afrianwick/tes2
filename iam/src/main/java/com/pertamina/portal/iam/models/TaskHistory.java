...
public class TaskHistory extends RealmObject {
    public String id;
    ...
    public TaskHistory(String id, boolean statusNotif, String folioNumber, String processName, String lastActivity) {
        this.id = id;
