...
import com.pertamina.portal.iam.fragments.EcorrMenuFragment;
...
public class EcorrHomeActivity extends AppCompatActivity implements EcorrMenuFragment.OnFragmentInteractionListener,
    ...
    private EcorrMenuFragment menuFragment;
    private SettingsFragment settingFragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecorr_home);
        BottomNavigationView navView = findViewById(R.id.nav_view);
        navView.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);

        menuFragment = EcorrMenuFragment.newInstance(null, null);
