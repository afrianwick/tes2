...
public class TaskPending extends RealmObject {
    public String id;
    ...
    public TaskPending(String id, boolean statusNotif, String folioNumber, String processName, String lastActivity) {
        this.id = id;
