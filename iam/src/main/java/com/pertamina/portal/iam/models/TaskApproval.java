...
public class TaskApproval extends RealmObject {
    public String id;
    ...
    public TaskApproval(String id, boolean statusNotif, String folioNumber, String processName, String lastActivity) {
        this.id = id;
