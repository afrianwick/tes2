...
/**
 * {@link RecyclerView.Adapter} that can display a {@link TaskHistory} and makes a call to the
 * specified {@link OnListFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class ListWorklistHistoryAdapter extends RecyclerView.Adapter<ListWorklistHistoryAdapter.ViewHolder> {

    private final List<TaskHistory> mValues;
    private final OnListFragmentInteractionListener mListener;
    private final Activity mActivity;

    public ListWorklistHistoryAdapter(Activity activity, List<TaskHistory> items, OnListFragmentInteractionListener listener) {
        mActivity = activity;
        mValues = items;
        mListener = listener;
    }
