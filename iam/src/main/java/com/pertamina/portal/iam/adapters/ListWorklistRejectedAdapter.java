...
/**
 * {@link RecyclerView.Adapter} that can display a {@link TaskRejected} and makes a call to the
 * specified {@link OnListFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class ListWorklistRejectedAdapter extends RecyclerView.Adapter<ListWorklistRejectedAdapter.ViewHolder> {

    private final List<TaskRejected> mValues;
    private final OnListFragmentInteractionListener mListener;
    private final Activity mActivity;

    public ListWorklistRejectedAdapter(Activity activity, List<TaskRejected> items, OnListFragmentInteractionListener listener) {
        mActivity = activity;
        mValues = items;
        mListener = listener;
    }
